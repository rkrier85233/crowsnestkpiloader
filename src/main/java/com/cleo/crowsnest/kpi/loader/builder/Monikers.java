...
public final class Monikers {
    private static final Random RANDOM = new Random();
    private static HashSet<String> USED = new HashSet<>();

    private static final String[] LEFT = {"admiring", "adoring", "affectionate", "agitated", "amazing", "angry",
        "awesome", "blissful", "boring", "brave", "clever", "cocky", "compassionate", "competent", "condescending",
        ...
        "infallible", "inspiring", "jolly", "jovial", "keen", "kind", "laughing", "loving", "lucid", "mystifying",
        "modest", "musing", "naughty", "nervous", "nifty", "nostalgic", "objective", "optimistic", "peaceful",
        "pedantic", "pensive", "practical", "priceless", "quirky", "quizzical", "relaxed", "reverent", "romantic",
        "sad", "serene", "sharp", "silly", "sleepy", "stoic", "stupefied", "suspicious", "tender", "thirsty",
    ...
    private static final String[] RIGHT = {
        ...
        // humanitarian. She was the first woman to write a mathematics handbook and the first
        // woman appointed as a Mathematics Professor at a University.
        // https://en.wikipedia.org/wiki/Maria_Gaetana_Agnesi
        "agnesi",

        // Archimedes was a physicist, engineer and mathematician who invented too many things
        // to list them here. https://en.wikipedia.org/wiki/Archimedes
        "archimedes",
        ...
        // motorcar. https://en.wikipedia.org/wiki/Karl_Benz
        "benz",

        // Homi J Bhabha - was an Indian nuclear physicist, founding director, and professor of
        // physics at the Tata Institute of Fundamental Research. Colloquially known as "father
        // of Indian nuclear programme"- https://en.wikipedia.org/wiki/Homi_J._Bhabha
        "bhabha",
        ...
        // Emmett Brown invented time travel. https://en.wikipedia.org/wiki/Emmett_Brown (thanks
        // Brian Goff)
        "brown",

        // Rachel Carson - American marine biologist and conservationist, her book Silent Spring
        ...
        // physics - https://en.wikipedia.org/wiki/Subrahmanyan_Chandrasekhar
        "chandrasekhar",
        ...
        // American woman—to win a Nobel Prize in science, and the first woman to be awarded the
        // Nobel Prize in Physiology or Medicine. Cori was born in Prague.
        // https://en.wikipedia.org/wiki/Gerty_Cori
        "cori",

        // Seymour Roger Cray was an American electrical engineer and supercomputer architect
        // who designed a series of computers that were the fastest in the world for decades.
        ...
        // Samuel Curran was an Irish physicist who worked alongside his wife during WWII and
        // invented the proximity fuse. https://en.wikipedia.org/wiki/Samuel_Curran
        "curran",
        ...
        // Benjamin Franklin is famous for his experiments in electricity and the invention of
        // the lightning rod.
        "franklin",
        ...
        // first electronic digital computer, ENIAC.
        ...
        // of modern cryptography. Winner of 2012 ACM Turing Award.
        ...
        // Lois Haibt - American computer scientist, part of the team at IBM that developed
        // FORTRAN - https://en.wikipedia.org/wiki/Lois_Haibt
        "haibt",

        // Margaret Hamilton - Director of the Software Engineering Division of the MIT
        // Instrumentation Laboratory, which developed on-board flight software for the Apollo
        // space program. https://en.wikipedia.org/wiki/Margaret_Hamilton_(scientist)
        "hamilton",
        ...
        // foundations of quantum mechanics. https://en.wikipedia.org/wiki/Grete_Hermann
        "hermann",
        ...
        // work was polarography. https://en.wikipedia.org/wiki/Jaroslav_Heyrovsk%C3%BD
        "heyrovsky",
        ...
        // to the understanding of semiconductors, integrated circuitry, and the unique
        // electrical principles of microscopic materials.
        ...
        // (OLPC), and the founder of Pixel Qi. https://en.wikipedia.org/wiki/Mary_Lou_Jepsen
        "jepsen",

        // Katherine Coleman Goble Johnson - American physicist and mathematician contributed to
        // the NASA. https://en.wikipedia.org/wiki/Katherine_Johnson
        "johnson",

        // Irène Joliot-Curie - French scientist who was awarded the Nobel Prize for Chemistry
        // in 1935. Daughter of Marie and Pierre Curie.
        // https://en.wikipedia.org/wiki/Ir%C3%A8ne_Joliot-Curie
        "joliot",

        // Karen Spärck Jones came up with the concept of inverse document frequency, which is
        // used in most search engines today.
        ...
        // Susan Kare, created the icons and many of the interface elements for the original
        // Apple Macintosh in the 1980s, and was an original employee of NeXT, working as the
        // Creative Director. https://en.wikipedia.org/wiki/Susan_Kare
        "kare",

        // Mary Kenneth Keller, Sister Mary Kenneth Keller became the first American woman to
        // earn a PhD in Computer Science in 1965.
        ...
        // Hedy Lamarr - Actress and inventor. The principles of her work are now incorporated
        // into modern Wi-Fi, CDMA and Bluetooth technology.
        ...
        // optimization techniques for routing traffic on the internet. Died attempting to stop
        // the 9-11 hijackers. https://en.wikipedia.org/wiki/Daniel_Lewin
        "lewin",

        // Ruth Lichterman - one of the original programmers of the ENIAC.
        // https://en.wikipedia.org/wiki/ENIAC - https://en.wikipedia.org/wiki/Ruth_Teitelbaum
        "lichterman",
        ...
        // proposing the nuclear shell model of the atomic nucleus -
        ...
        // nuclear fission. The element meitnerium is named after her -
        // https://en.wikipedia.org/wiki/Lise_Meitner
        "meitner",

        // Carla Meninsky, was the game designer and programmer for Atari 2600 games Dodge 'Em
        // and Warlords. https://en.wikipedia.org/wiki/Carla_Meninsky
        "meninsky",
        ...
        // Maryam Mirzakhani - an Iranian mathematician and the first woman to win the Fields
        // Medal. https://en.wikipedia.org/wiki/Maryam_Mirzakhani
        "mirzakhani",

        // Samuel Morse - contributed to the invention of a single-wire telegraph system based
        // on European telegraphs and was a co-developer of the Morse code -
        ...
        // in her Ph.D. thesis an explanation for the composition of stars in terms of the
        ...
        // crypto tools, advances the causes of truth and freedom of information by reporting
        // disclosures by whistleblowers such as Edward Snowden.
        // https://en.wikipedia.org/wiki/Laura_Poitras
        "poitras",

        // Claudius Ptolemy - a Greco-Egyptian writer of Alexandria, known as a mathematician,
        // astronomer, geographer, astrologer, and poet of a single epigram in the Greek
        // Anthology - https://en.wikipedia.org/wiki/Ptolemy
        "ptolemy",
        ...
        // fractions. - https://en.wikipedia.org/wiki/Srinivasa_Ramanujan
        "ramanujan",
        ...
        // Rosalind Franklin - British biophysicist and X-ray crystallographer whose research
        // was critical to the understanding of DNA -
        // https://en.wikipedia.org/wiki/Rosalind_Franklin
        "rosalind",

        // Meghnad Saha - Indian astrophysicist best known for his development of the Saha
        // equation, used to describe chemical and physical conditions in stars -
        ...
        // manipulation of mathematical formulas. https://en.wikipedia.org/wiki/Jean_E._Sammet
        "sammet",

        // Carol Shaw - Originally an Atari employee, Carol Shaw is said to be the first female
        // video game designer. https://en.wikipedia.org/wiki/Carol_Shaw_(video_game_designer)
        "shaw",

        // Dame Stephanie "Steve" Shirley - Founded a software company in 1962 employing women
        // working from home. https://en.wikipedia.org/wiki/Steve_Shirley
        "shirley",
        ...
        // Françoise Barré-Sinoussi - French virologist and Nobel Prize Laureate in Physiology
        // or Medicine; her work was fundamental in identifying HIV as the cause of AIDS.
        ...
        // project, the Free Software Foundation, and the League for Programming Freedom. He
        // also invented the concept of copyleft to protect the ideals of this movement, and
        // enshrined this concept in the widely-used GPL (General Public License) for software.
        ...
        // Janese Swanson (with others) developed the first of the Carmen Sandiego games. She
        // went on to found Girl Tech. https://en.wikipedia.org/wiki/Janese_Swanson
        "swanson",

        // Aaron Swartz was influential in creating RSS, Markdown, Creative Commons, Reddit, and
        // much of the internet as we know it today. He was devoted to freedom of information on
        // the web. https://en.wikiquote.org/wiki/Aaron_Swartz
        "swartz",

        // Bertha Swirles was a theoretical physicist who made a number of contributions to
        // early quantum theory. https://en.wikipedia.org/wiki/Bertha_Swirles
        "swirles",

        // Nikola Tesla invented the AC electric system and every gadget ever used by a James
        // Bond villain. https://en.wikipedia.org/wiki/Nikola_Tesla
        "tesla",
        ...
        // Varahamihira - Ancient Indian mathematician who discovered trigonometric formulae
        // during 505-587 CE - https://en.wikipedia.org/wiki/Var%C4%81hamihira#Contributions
        "varahamihira",

        // Sir Mokshagundam Visvesvaraya - is a notable Indian engineer. He is a recipient of
        // the Indian Republic's highest honour, the Bharat Ratna, in 1955. On his birthday, 15
        ...
        // Theorem - https://en.wikipedia.org/wiki/Andrew_Wiles
        "wiles",
        ...
        // processors. https://en.wikipedia.org/wiki/Sophie_Wilson
        "wilson",
        ...
        // Rosalyn Sussman Yalow - Rosalyn Sussman Yalow was an American medical physicist, and
        // a co-winner of the 1977 Nobel Prize in Physiology or Medicine for development of the
        // radioimmunoassay technique. https://en.wikipedia.org/wiki/Rosalyn_Sussman_Yalow
        "yalow",

        // Ada Yonath - an Israeli crystallographer, the first woman from the Middle East to win
        // a Nobel prize in the sciences. https://en.wikipedia.org/wiki/Ada_Yonath
        "yonath"
    };
    ...
    public static String getRandomName() {
        while (true) {
            String moniker = String.format("%s_%s", LEFT[RANDOM.nextInt(LEFT.length)], RIGHT[RANDOM.nextInt(RIGHT.length)]);
            if (!USED.contains(moniker)) {
                USED.add(moniker);
                return moniker;
            }
        }
